  ...
  return (
    <div className="bg-white text-slate-900 font-sans selection:bg-orange-100 relative">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 bg-[#2b3a55] text-white w-12 h-12 rounded-full shadow-2xl flex items-center justify-center transition-opacity duration-300 border border-white/10"
