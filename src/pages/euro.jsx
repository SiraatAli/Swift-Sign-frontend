  ...
  return (
    <div className="bg-white text-slate-900 font-sans selection:bg-orange-100 relative">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-10 right-10 z-[999] bg-[#2b3a55] text-white w-12 h-12 rounded-full shadow-2xl flex items-center justify-center transition-opacity duration-300"
