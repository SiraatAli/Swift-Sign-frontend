  ...
  const testimonials = [
    {
      ...
      role: "BDM",
      image:
        "https://landscapegalaxy.com/wordpress/wp-content/uploads/2022/04/team3.jpg",
    ...
    },
    {
      ...
      image:
        "https://janelaswp.themesflat.co/wp-content/uploads/2022/04/imgtestimonio2.jpg",
    ...
    },
    {
      ...
      role: "Admin Mnager",
      image:
        "https://janelaswp.themesflat.co/wp-content/uploads/2022/04/imgtestimonio1.jpg",
  ...
  return (
    <div className="bg-white text-slate-900 font-sans selection:bg-orange-100 relative">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 bg-[#2b3a55] text-white w-12 h-12 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 animate-bounce"
