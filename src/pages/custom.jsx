...
const Custom = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-blue-100 pb-20 relative">
      {/* SCROLL TO TOP BUTTON */}
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-10 right-10 z-50 bg-[#1e293b] text-white p-3 rounded-full shadow-2xl hover:bg-blue-900 transition-all duration-300 animate-bounce group"
      ...
      <section className="relative h-[250px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <nav className="text-sm font-medium flex items-center justify-center gap-3">
            ...
            <span>|</span>
            <span className="opacity-80">Custom Size Pallets</span>
          </nav>
        </div>
      </section>
