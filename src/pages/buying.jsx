  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-blue-100 pb-20">
      ...
      <section className="relative h-[250px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <nav className="text-sm font-medium flex items-center justify-center gap-3">
            ...
            <span>|</span>
            <span className="opacity-80">Buying Used Pallets</span>
          </nav>
        </div>
      </section>
      ...
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-10 right-10 z-50 bg-[#1e293b] text-white p-4 rounded-full shadow-2xl hover:bg-[#d4c3a3] hover:text-[#1e293b] transition-all duration-300 group animate-bounce"
          aria-label="Scroll to top"
        >
          <svg
            viewBox="0 0 24 24"
            className="w-6 h-6 fill-none stroke-current stroke-2 group-hover:-translate-y-1 transition-transform"
          >
